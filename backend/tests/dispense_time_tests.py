...
def test_dispense_times_insert_dispense_time(db_session: Session):
    dispense_time = DispenseTime(user_id = 1, 
                                 time = dt_time(18, 30, 0))
...
def test_dispense_times_delete_dispense_time(db_session: Session):
    ...
    db_session.delete(dispense_time)
    db_session.commit()
...
def test_dispense_times_null_data(db_session: Session):
    dispense_time = DispenseTime(user_id = None, 
                                 time = None)
...
def test_dispense_times_order_records(db_session: Session):
    dispense_time1 = DispenseTime(user_id = 1, 
                                  time = dt_time(18, 30, 0))
    dispense_time2 = DispenseTime(user_id = 1, 
                                  time = dt_time(12, 0, 0))
